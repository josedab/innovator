...
export const BADGE_DEFINITIONS: BadgeDefinition[] = [
  {
    id: "first-spark",
    name: "First Spark",
    description: "Run your first investigation",
    icon: "⚡",
  ...
  },
  {
    id: "explorer-10",
    name: "Explorer",
    description: "Run 10 investigations",
    icon: "🔍",
    category: "exploration",
    condition: "Complete 10 investigations",
    threshold: 10,
    points: 50,
    rarity: "uncommon",
  },
  {
    id: "pathfinder",
    name: "Pathfinder",
    description: "Use 5 different angles",
    icon: "🧭",
    category: "exploration",
    condition: "Use 5 unique angles",
    threshold: 5,
    points: 30,
    rarity: "uncommon",
  },
  {
    id: "angle-master",
    name: "Angle Master",
    description: "Use all 8 built-in angles",
    icon: "🎯",
    category: "mastery",
    condition: "Use all 8 angles",
    threshold: 8,
    points: 100,
    rarity: "rare",
  },
  {
    id: "idea-machine",
    name: "Idea Machine",
    description: "Generate 100 ideas total",
    icon: "💡",
    category: "creativity",
    condition: "Generate 100 ideas",
    threshold: 100,
    points: 75,
    rarity: "rare",
  },
  {
    id: "quality-critic",
    name: "Quality Critic",
    description: "Score 10 ideas",
    icon: "⭐",
    category: "quality",
    condition: "Score 10 ideas",
    threshold: 10,
    points: 40,
    rarity: "uncommon",
  },
  {
    id: "streak-3",
    name: "On Fire",
    description: "3-day innovation streak",
    icon: "🔥",
  ...
  },
  {
    id: "streak-7",
    name: "Unstoppable",
    description: "7-day innovation streak",
    icon: "🌟",
    category: "consistency",
  ...
  },
  {
    ...
    description: "30-day innovation streak",
    icon: "👑",
    category: "consistency",
  ...
  },
  {
    id: "influencer",
    name: "Influencer",
    description: "Get 20 votes on your ideas",
    icon: "📣",
    category: "collaboration",
    condition: "Receive 20 votes",
    threshold: 20,
    points: 60,
    rarity: "rare",
  },
  {
    id: "speed-demon",
    name: "Speed Demon",
    description: "Complete investigation in under 30s",
    icon: "⏱️",
    category: "speed",
    condition: "Fast investigation",
    threshold: 1,
    points: 25,
    rarity: "uncommon",
  },
  {
    id: "deep-diver",
    name: "Deep Diver",
    description: "Refine an idea 5 times",
    icon: "🤿",
    category: "quality",
    condition: "5 refinements on one idea",
    threshold: 5,
    points: 50,
    rarity: "rare",
  },
  {
    ...
    description: "Use cross-domain angle 10 times",
    icon: "🐝",
    category: "creativity",
    condition: "10 cross-domain runs",
    threshold: 10,
    points: 60,
    rarity: "rare",
  },
  {
    id: "architect",
    name: "Architect",
    description: "Generate 5 PRDs",
    icon: "📐",
    category: "mastery",
    condition: "Generate 5 PRDs",
    threshold: 5,
    points: 80,
    rarity: "rare",
  },
  {
    id: "storyteller",
    name: "Storyteller",
    description: "Create 3 pitch decks",
    icon: "📖",
    category: "creativity",
    condition: "Create 3 pitch decks",
    threshold: 3,
    points: 60,
    rarity: "rare",
  },
  {
    id: "data-driven",
    name: "Data Driven",
    description: "Track 10 outcomes",
    icon: "📊",
    category: "quality",
    condition: "Track 10 outcomes",
    threshold: 10,
    points: 50,
    rarity: "uncommon",
  },
  ...
  },
  {
    id: "trailblazer",
    name: "Trailblazer",
    description: "Create a custom angle pack",
    icon: "🚀",
    category: "creativity",
    condition: "Publish 1 angle pack",
    threshold: 1,
    points: 40,
    rarity: "uncommon",
  },
