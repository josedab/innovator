...
const samplePriorArt: PriorArtEntry[] = [
  {
    ...
    description: "Machine learning algorithm that adjusts solar panel angles in real-time based on weather data and satellite imagery to maximize energy output.",
    similarity: 0,
  ...
  },
  {
    ...
    description: "Novel approach using deep RL to optimize energy distribution in smart grid networks, reducing waste by 23% in simulation.",
    similarity: 0,
  ...
  },
  {
    ...
    description: "Commercial product that uses machine learning to optimize solar inverter performance and predict maintenance needs.",
    similarity: 0,
  ...
  },
  {
    ...
    description: "Decentralized platform enabling households to trade surplus solar energy with neighbors using smart contracts.",
    similarity: 0,
  ...
  },
  {
    ...
    description: "Research demonstrating functional solar cells made from agricultural waste products, achieving 8% efficiency with full biodegradability.",
    similarity: 0,
...
describe("assessNovelty", () => {
  it("returns high novelty for unrelated ideas when store is empty", () => {
    const result = assessNovelty("quantum teleportation", "Teleport objects using quantum entanglement");
...
describe("generateNoveltyReport", () => {
  it("generates a report for multiple ideas", () => {
    ...
    const report = generateNoveltyReport([
      { title: "Underwater DNA storage", description: "Store data in synthetic DNA for underwater drones" },
      { title: "AI solar optimization", description: "Machine learning for solar panel angle optimization based on weather" },
      { title: "Quantum grid balancing", description: "Use quantum computing to optimize smart grid energy distribution" },
