...
const ENDPOINTS: PlaygroundEndpoint[] = [
  {
    ...
    description: "Investigate a subject with AI",
    body: { subject: "AI in healthcare" },
  },
  {
    name: "Auto Pipeline",
    method: "POST",
    ...
    body: { subject: "sustainable packaging" },
  },
  {
    name: "Score Ideas",
    method: "POST",
    path: "/api/score",
    description: "Score ideas across dimensions",
    body: { subject: "remote work tools", angleResults: [] },
  },
  {
    name: "Wargaming",
    method: "POST",
    path: "/api/wargaming",
    description: "Competitive wargaming simulation",
    body: {
      subject: "AI chatbots",
      ideaTitle: "Context-Aware Assistant",
      ideaDescription: "An AI assistant that maintains deep context",
      rounds: 3,
    },
  },
  {
    ...
    description: "Map innovation supply chain",
    body: {
      subject: "electric vehicles",
      ideaTitle: "Solid-State Battery",
      ideaDescription: "Next-gen solid-state batteries for EVs",
    },
  },
  {
    ...
    method: "POST",
    path: "/api/timing",
    description: "Predict optimal execution timing",
    body: {
      subject: "quantum computing",
      ideas: [{ title: "Quantum ML", description: "Machine learning on quantum hardware" }],
    },
  },
  {
    name: "Team DNA",
    method: "POST",
    path: "/api/team-dna",
    description: "Analyze team innovation patterns",
    body: { teamId: "engineering", memberIds: ["user-1", "user-2"] },
  },
  {
  ...
  },
  {
    ...
    description: "LLM cost-performance report",
    body: {},
  },
  {
    name: "Rubrics",
    method: "GET",
    path: "/api/rubric",
    description: "List scoring rubrics",
    body: {},
  },
];
    ...
    <div className="min-h-screen bg-gray-950 text-white p-8">
      <div className="max-w-7xl mx-auto">
        ...
        <p className="text-gray-400 mb-8">
          Explore the Innovator API with live examples and code snippets
        </p>
          ...
          <div className="col-span-3">
            ...
            <div className="space-y-1">
              {ENDPOINTS.map((ep) => (
                ...
                >
                  <span
                    className={`inline-block w-12 font-mono text-xs ${ep.method === "GET" ? "text-green-400" : "text-yellow-400"}`}
                  >
                    {ep.method}
                  </span>
                  {ep.name}
          ...
          <div className="col-span-9 space-y-6">
            ...
            <div className="bg-gray-900 rounded-xl p-6 border border-gray-800">
              <div className="flex items-center gap-3 mb-2">
                <span
                  className={`px-2 py-0.5 rounded text-xs font-mono ${selected.method === "GET" ? "bg-green-900 text-green-300" : "bg-yellow-900 text-yellow-300"}`}
                >
                  {selected.method}
                </span>
            ...
            {(response || error) && (
              <div>
                ...
                <pre
                  className={`bg-gray-900 border rounded-lg p-4 text-sm overflow-auto max-h-96 ${error ? "border-red-800 text-red-300" : "border-gray-700 text-green-300"}`}
                >
                  {error || response}
                </pre>
              </div>
