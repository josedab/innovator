      ...
      <header className="hero hero--innovator">
        <div className="container text--center">
          ...
          <p className="hero__subtitle">
            Explore any subject from 8 proven innovation angles — powered by AI, driven by your
            Copilot subscription.
          </p>
          <div className="install-block">npm install && npm run dev</div>
        ...
        <section className="container margin-vert--xl">
          ...
          <div style={{ maxWidth: 700, margin: "0 auto", fontSize: "1.1rem" }}>
            ...
            >
              ...
              <div>
                <strong>Enter a subject</strong> — any technology, product, process, or idea you
                want to innovate on.
              </div>
            </div>
            <div
            ...
            >
              ...
              <div>
                <strong>AI investigates</strong> — identifies key aspects, state of the art,
            ...
            >
              ...
              <div>
                <strong>Choose your angles</strong> — pick which innovation frameworks to apply, or
                use Auto Mode for all 8.
              </div>
            </div>
            <div style={{ display: "flex", gap: "1rem", alignItems: "flex-start" }}>
              ...
              <div>
                <strong>Get actionable ideas</strong> — each idea includes description, potential
                impact, and implementation hints. Auto Mode adds a ranked synthesis.
              </div>
            </div>
          </div>
        </section>
